...
const SeanceCodeTable = () => {
  const [c, setUserCin]=useState('');
        ...
        return employees && employees.map(({ id, type, date, startTime,monitorCin,userCin,plaque,duration }) => {
          ...
          return (
                <tr key={id}>
                   ...
                   <td> <Popup
                   contentStyle={{width: "500px"}} trigger={<button ><UpdateIcon/> </button>} position=" top center">
                         <div>
                         <div style={{ 
      width:'100%',
    ...
    return (
        <div>
            <br/>
            <h1 id='title' className="seancecodetitle">Highway Code Sessions Table</h1>
            <div className="add"><Popup
                   contentStyle={{width: "500px"}} trigger={<button  className="btn-custom-sc1 btn-custom-sc15 "><AddIcon /> New </button>} position=" top right">
                         <div>
                         <div style={{ 
      width:'100%',
      backgroundPosition: 'center',
