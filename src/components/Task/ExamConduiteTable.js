...
import image from '../dashbord/DataTable/vert.jpg';
...
const ExamConduiteTable = () => {
  ...
  const[p, setPlaque]=useState('');
    ...
    const update =( id, Date, StartTime,MonitorCin,User,Plaque,Duration)=>{
      const res =  axios.put(`${URL}/${id}`, { type:2, date:Date, startTime:StartTime,monitorCin:MonitorCin,userCin:User
          ,plaque:Plaque,duration:Duration});

  }

    const renderHeader = () => {
        let headerElement = ['Monitor Cin', 'Candidate Cin','Date', 'StartTime','Duration','Matriculation','Update','Delete']
      ...
      <div >
        ...
        <form  type="submit" >
          <Grid container spacing={2}>
            ...
            onClick={() => update(id, d, s,m,c,p,du)}
          >
            Set
          </Button>
    ...
    return (
        <div>
            ...
            <div className="add"><Popup
                   contentStyle={{width: "500px"}} trigger={<button  className="btn-custom-sc1 btn-custom-sc18 "><AddIcon /> New </button>} position=" top right">
                         <div>
                         <div style={{ 
      width:'100%',
      backgroundPosition: 'center',
