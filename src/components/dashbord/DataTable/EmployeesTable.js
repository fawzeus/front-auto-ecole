...
const EmployeesTable = () => {
  ...
  return (
    <div>
      <br />
      <h1 id="title" className="employeestitle">
        Employees Table
      </h1>
      <div className="add">
        <Popup
          ...
          trigger={
            <button className="btn-custom-sc13 btn-custom-sc1 ">
              <PersonAddIcon /> New{" "}
            </button>
          }
          position=" top right"
            ...
            >
              <Container component="main" maxWidth="L">
                <div className="formtitle">
                  <br />
                  <Avatar className={classes2.avatar}></Avatar>
      ...
      <br />
      <table id="students" className="employees">
        <thead>
          <tr>{renderHeader()}</tr>
        </thead>
