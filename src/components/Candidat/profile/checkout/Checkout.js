...
function getStepContent(step) {
  switch (step) {
    case 0:
      return <AddressForm setFname={setFname} setLname={setLname} setAdress={setAdress}
    ...
    case 2:
      return <Review price={price} fname={fname} lname={lname} adress={adress}  city={city} region={region} 
          ...
          <React.Fragment>
              ...
              <React.Fragment>
                ...
                <div className={classes.buttons}>
                  ...
                  >
                    {activeStep === steps.length - 1 ? 'Profile' : 'Next'}
                  </Button>
                </div>
              </React.Fragment>
